...
public class AuthorizationService {
   ...
   *
   * @param user      the caller from {@link com.phuchoang2005.aitraining.auth.CurrentUserContext}
   * @param projectId the project to check
   * @return the resolved project
   * @throws com.phuchoang2005.aitraining.auth.ForbiddenException if the user is not the owner
   ...
   *
   * @return the resolved project
   * @throws com.phuchoang2005.aitraining.auth.ForbiddenException if visibility is denied
   */
   ...
   *
   * @throws com.phuchoang2005.aitraining.auth.ForbiddenException if the user is not an admin
   */
