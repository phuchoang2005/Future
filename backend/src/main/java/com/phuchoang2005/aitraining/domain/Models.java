package com.phuchoang2005.aitraining.domain;

import com.phuchoang2005.aitraining.domain.Enums.*;
 ...
 * {@link com.phuchoang2005.aitraining.config.MongoConfig} configures the driver to use the
 ...
 * {@link com.phuchoang2005.aitraining.config.MongoSeedConfig}.
 */
public final class Models {
   ...
   * See {@link com.phuchoang2005.aitraining.repo.UserRepository#findActiveByToken}.
   *
  ...
  public record Project(
      ...
      String status,
      /**
       * State of the per-project Docker image build ({@code "BUILDING"} / {@code "READY"} /
       * {@code "FAILED"}); not an enum to allow future values. The image is built off the request
       * thread at registration, so a project is {@code "BUILDING"} until the build finalizes —
       * jobs may only be started once it is {@code "READY"}.
       */
      String buildStatus,
      /** Combined {@code docker build} output; {@code null} while building. */
      String buildLog,
      Instant createdAt,
      Instant updatedAt) {}
  ...
  public record ProjectConfig(
      ...
      String configPath,
      /** The full YAML text; validated on write via {@link com.phuchoang2005.aitraining.service.ConfigService}. */
      String yamlContent,
   ...
   *
   * <p>The lifecycle is managed by {@link com.phuchoang2005.aitraining.service.JobService} for
   * user-facing transitions (start, cancel, retry) and by
   * {@link com.phuchoang2005.aitraining.runner.AbstractTrainingRunner} for execution-phase transitions
  ...
  public record TrainingJob(
       ...
       * Recomputed by {@link com.phuchoang2005.aitraining.repo.JobQueueRepository#refreshPositions()}
