...
| **8. Log Streaming**           | Log từ stdout/stderr được đọc bằng process nào? Đẩy lên UI bằng WebSocket/SSE/Polling? Lưu log ở file hay DB?                                              | **Log Streaming Architecture Diagram**                    |
